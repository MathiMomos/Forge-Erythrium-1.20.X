...
public class ModCreativeModeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> ERYTHRIUM_TAB = CREATIVE_MODE_TABS.register("erythrium_blocks_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModBlocks.CHISELED_ERYTHRIUM_BLOCK.get()))
                    .title(Component.translatable("erythrium.erythrium_blocks_tab"))
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(ModBlocks.SOULBLOOM_ROOTS.get());
                        pOutput.accept(ModBlocks.GLOWING_OBSIDIAN.get());
                    })
                    .build());

    public static final RegistryObject<CreativeModeTab> ERYTHRIUM_ITEMS_TAB = CREATIVE_MODE_TABS.register("erythrium_items_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.ERYTHRIUM.get()))
                    .title(Component.translatable("erythrium.erythrium_items_tab"))
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(ModItems.GUST_MUSIC_DISC.get());
